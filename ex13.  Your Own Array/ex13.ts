...
let favoritetransportation: Array<[Brand: string, Transport: string, Color: string, Model: string]> = []
...
favoritetransportation.forEach(([Brand, Transport, Color, Model]) =>
{console.log(`I would like to own a ${Brand}'s ${Transport} in ${Color} color of model ${Model}.`)}
)   
